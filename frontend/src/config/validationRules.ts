...
export const ALL_RULES: (ValidationRule & { group?: RuleGroup })[] = [
  ...
  { code: 'R14b', label: 'Attestation fiscale = fournisseur facture', desc: 'Controle dedie : l\'attestation fiscale appartient bien au fournisseur facture. Compare raison sociale (similarite), ICE et IF entre la facture et l\'attestation. Toute divergence est non conforme (et pas simple avertissement).', category: 'system', appliesToBC: true, appliesToContractuel: true, group: 'identifiants' },
